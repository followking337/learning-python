...
print('16548946'.isdigit())  # состоит ли строка целиком из цифр? да
print('1654 894 6'.isdigit())  # состоит ли строка целиком из цифр? нет, присутствуют пробелы
print(int('432'))
...
print('\n.join()')  # при помощи метода join мы можем из списка получить строку
a = ['16516', '616468', '3154894']
print('='.join(a))
print('hello'.join(a))
b = [16516, 616468, 3154894]  # используется только со списками которые состоят из строк
# print('='.join(b))  # TypeError: sequence item 0: expected str instance, int found
# сперва нужно преобразовать элементы списка b в строки через генератор списков или через функцию map
